const Contact = () => {
    return (
        <section className="rounded-3xl container mx-auto" id="contato">
			<article className="bg-black shadow-2xl border-lime-800 border-4 rounded-3xl">
				<div className="p-6 shadow-2xl">
					<h3 className="text-3xl sm:text-5xl font-bold text-green-800 mb-10">CONTATO</h3>
					<p className="text-lime-300 text-xl sm:text-2xl mb-10">
						Entre em contato para orçamentos, feedbacks, colaborações, etc...
						Responderei assim que possível.
					</p>
				</div>
				<div className="p-6 bg-green-950 bg-opacity-80 max-h-full rounded-b-2xl h-fit z-10">
					<form className="space-y-4 text-lime-100" action="https://formspree.io/f/xzbqjkjp" method="POST">
						...
						<div className="flex justify-center">
							<button type="submit" className="bg-black font-ligther text-lime-100 text-xl sm:text-3xl p-12 py-2 px-4 rounded-3xl
						hover:bg-green-700 hover:text-lime-300 hover:shadow-2xl ">Submit</button>
						</div>
					</form>
				</div>
			</article>
